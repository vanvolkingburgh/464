...
-- Schema amazongo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `amazongo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `AmazonGo` ;

-- -----------------------------------------------------
-- Table `AmazonGo`.`Customer`
-- -----------------------------------------------------


-- -----------------------------------------------------
-- Table `AmazonGo`.`table1`
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `amazongo`.`PaymentMethods` (
  ...
  `Address` VARCHAR(45) NOT NULL,
  `CustomerID` VARCHAR(36) NOT NULL,
  PRIMARY KEY (`PaymentMethodID`, `CustomerID`),
  INDEX `fk_PaymentMethods_Customers1_idx` (`CustomerID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `amazongo`.`Inventory` (
  ...
  `StockLevel` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amazongo`.`RestockOrder` (
  ...
  `RestockThreshold` VARCHAR(45) NOT NULL,
  `SupplierID` INT NOT NULL,
  `InventoryID` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amazongo`.`FraudDetectionLog` (
  ...
  `DetectionType` VARCHAR(45) NOT NULL,
